...
CREATE TABLE `a_user` (
  ...
  `sex` char(2) NOT NULL COMMENT '男,女',
...
insert  into `a_user`(`id`,`name`,`sex`,`age`,`address`,`time`,`update_time`,`delete_time`) values (6,'张三','男',30,'东莞南城','2016-10-22','2019-04-18',NULL),(7,'李四','男',24,'东莞南城','2016-01-02',NULL,'2019-04-18');
...
insert  into `take_goods`(`id`,`price`,`goods_name`,`belong_store_id`,`belong_category_id`,`storage`,`image`,`create_host`,`create_time`,`update_time`,`delete_time`) values (9,'12.00','茶123',25,23,7,'/uploads/20190412\\7186164d623f186919e3ffb50c118053.bmp',4,1555071815,1555117476,NULL),(10,'15.00','奶茶123',25,23,4,'/uploads/20190412\\6f5ad45401b9360f8e0b6f561b581570.bmp',4,1555071837,1555117476,NULL);
...
insert  into `take_user`(`id`,`nick`,`username`,`pwd`,`phone`,`status`,`create_time`,`update_time`,`delete_time`,`sex`) values (1,'小李','sss','123','123',1,2147483647,NULL,NULL,1),(2,'小王','www','1','123',1,2147483647,NULL,NULL,1),(3,'小马','mmm','1','123',1,2147483647,NULL,NULL,0),(4,'小花','hhh','1','123',1,2147483647,NULL,NULL,1),(5,'老王','laow','','',1,1555116300,1555116300,NULL,NULL);

/*Table structure for table `test_varchar` */

DROP TABLE IF EXISTS `test_varchar`;

CREATE TABLE `test_varchar` (
  `aa` varchar(20) DEFAULT NULL,
  `bb` int(5) unsigned zerofill DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

/*Data for the table `test_varchar` */

insert  into `test_varchar`(`aa`,`bb`) values ('一二三四五六七八九十',1234567);
...
CREATE TABLE `topic` (
  ...
  `intro` varchar(255) NOT NULL COMMENT '专题介绍',
  `start_time` int(11) NOT NULL COMMENT '专题开始时间',
  `end_time` int(11) NOT NULL COMMENT '专题结束时间',
  `create_time` int(11) NOT NULL COMMENT '创建时间',
  `update_time` int(11) DEFAULT NULL COMMENT '更新时间',
  `delete_time` int(11) DEFAULT NULL COMMENT '删除时间',
  `total` smallint(6) DEFAULT NULL COMMENT '库存',
...
/*Table structure for table `zy_test_user` */

DROP TABLE IF EXISTS `zy_test_user`;

CREATE TABLE `zy_test_user` (
  `uid` smallint(6) NOT NULL AUTO_INCREMENT COMMENT '用户id',
  `username` varchar(20) NOT NULL COMMENT '用户名',
  `phone` char(11) NOT NULL COMMENT '手机号码',
  `sex` tinyint(1) NOT NULL COMMENT '性别:1-男、2-女、3-保密3种选择',
  `leval` tinyint(4) NOT NULL COMMENT '会员等级0-100',
...
/*Data for the table `zy_test_user` */
